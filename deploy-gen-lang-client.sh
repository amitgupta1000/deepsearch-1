#!/bin/bash
# deploy-gen-lang-client.sh - Project-specific deployment script for INTELLISEARCH
# Configured for project: gen-lang-client-0665888431
...
# Set the project (in case it's not already set)
